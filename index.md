...
## **Professional Self-Assessment**
 ...
 Hello all, my name is Graham Swenson and I currently reside in the Midwest and attend Southern New Hampshire University online. In this self-assessment I will answer the following questions. First, I will discuss how completing my coursework throughout the program and developing my ePortfolio has helped me showcase my strengths, shape my professional goals, and become more employable in the computer science field. I will do this by using specific examples from my program and include examples that are outside of my ePortfolio. Next, I will address collaborating in a team environment, communicating with stakeholders, data structures, algorithms, software engineering, databases, and security, all different aspects of computer science. I will then summarize and introduce how my artifacts fit together.
	
 In this first paragraph I will discuss how completing my coursework and developing my ePortfolio has helped me showcase my strengths. During my coursework I was able to discover that my strength lay in a few specializations. Those being embedded software engineering, project management, and java based databases. First, I was drawn to embedded software engineering because of the logic that is often tied with that form of coding. I appreciate discrete mathematics and its application to everyday situations. I live in an area where there is a lot of farming equipment, and I often think about how the different embedded modules are used to actuate different components on the combines or farming implements. The two classes that helped me discover this strength were CS350: Emerging Systems Architectures and Technologies and MAT230 Discrete Mathematics. The next strength I was able to discover was my knack for project management. Specifically working in an agile environment on a mock scrum team. I was specifically drawn to the role of product owner or the scrum master. Both jobs allow me to apply skills I have gained at my current employer or when I was in a leadership position in the military. A specific example outside of my ePortfolio is I have been promoted to a project management position at my current employer. Using the skills I gained from this school and doing research on my own, I was able to gain the necessary skills to undertake more responsibilities at work. One of the last strengths I will discuss here is java-based databases. I appreciate the language of Java and its lightweight versatility for creating databases. I have found myself going through life at home or work and realizing that I could “make a database for that”. Maybe it is a compulsion to organize items in a manner that makes sense to me, but I have found that I appreciate the plug and play abilities for making databases with Java. Additionally, I have been able to take the agile method, that I’ve learned in many different classes during my computer science courses, into my current work. Collaborating in a team environment, I can use principles from the “agile manifesto” to divide a project into manageable slices and assign them to the employee that has the appropriate strengths. Additionally, I have gained experience in communicating complex topics to lay individuals who are not familiar with technical terminology. Explaining a static vs. dynamic database to an individual that can’t tell the difference is a deciding factor in today’s job market. While the specific knowledge varies, being able to explain these complex topics in simple and concise ways allows for better work productivity between different sections, within an organization. During my coursework at SNHU, I’ve developed a good foundation in common data structures like arrays or linked lists. Additionally, I’ve gained the ability to develop robust and scalable applications using the object-oriented programing method. In relation to security, I’ve also gained the ability to write programs using secure coding practices. In today’s climate the ability to protect your program is a necessity. Malicious actors are indiscriminate in their desire to take bad actions against organizations and individuals. 
	
 In this next paragraph I will begin by summarizing and introducing how my artifacts fit together. In this ePortfolio you will see three separate sections that are covered, those are software design and engineering, algorithms and data structures, and databases. For software design and engineering I selected my final project for SNHU course CS320: Software Testing, Automation, and Quality Assurance. This is straightforward code that allows me to showcase my ability to write clean code that is functional and concise. The next section is titled algorithms and data structures, for this section I chose my C code for an embedded module from SNHU course CS350: Emerging Systems, Architectures, and Technologies. This shows my ability to engineering code for an embedded technology and do so in a logical and clean manner. Finally, the last section that is addressed in this ePortfolio is the databases section. For databases I was able to use my final project from SNHU course IT145: Foundation in Application Development. While the final project did not see us code any actual program, we created pseudocode and a map for this program. Being that this was a level 100 course, I wanted to come full circle and make this program; while also improving on it. 


---

## **Code Review** 
The following section are hyperlinks link to the code review performed for each of the original code used in the three artifacts. *It should be noted that the hyperlinks take you to the file location where you must download the .mp4 files to listen.*
...
*This section is in reference the following code:*

**Original**
- Original [OriginalContact.java](https://github.com/SkunkApe1/SkunkApe1.github.io/blob/main/OriginalContact.java).
- Oritinal [OriginalContactService.java](https://github.com/SkunkApe1/SkunkApe1.github.io/blob/main/OriginalContactService.java).
...
*This section is in reference to the following code:*

**Original**
- Original [Originalgpiointerrupt.c](https://github.com/SkunkApe1/SkunkApe1.github.io/blob/main/Originalgpiointerrupt.c)
...
**Original**
- (pseudocode only) [Original](https://github.com/SkunkApe1/SkunkApe1.github.io/blob/main/CS499%20-%20Part3%20(IT145)%20doc.docx)
